...
def seperate():
    image_path = "D:/Dataset/CelebAMask-HQ-mask/CelebAMask-HQ-maskRendering_473/images_mask_green/"
    ...
    hq_train_path = "D:/Dataset/CelebAMask-HQ-mask/CelebAMask-HQ-maskRendering_473/train/images_mask_green/"
    if not os.path.exists(hq_train_path):
        os.makedirs(hq_train_path)
    hq_valid_path = "D:/Dataset/CelebAMask-HQ-mask/CelebAMask-HQ-maskRendering_473/valid/images_mask_green/"
    if not os.path.exists(hq_valid_path):
        os.makedirs(hq_valid_path)
    hq_test_path = "D:/Dataset/CelebAMask-HQ-mask/CelebAMask-HQ-maskRendering_473/test/images_mask_green/"
    ...
    for images in image_list:
        # print(images)
        image = cv2.imread(image_path + images, cv2.IMREAD_COLOR)  # cv2.IMREAD_GRAYSCALE  / cv2.IMREAD_COLOR
