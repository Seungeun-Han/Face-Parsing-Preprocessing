...
save_dir = "D:/Dataset/ETRI_MaskDB/ETRI_MaskDB_partial_473/labels/"
...
for im_list in image_list:
    ...
    for idx, ann_list in enumerate(annotation_list):
        if parent_img_name in ann_list:
            ...
            # label = make_groundTruth(parsing_anno, ann_list[16:-4])
            # label = make_groundTruth(parsing_anno, ann_list[9:-4])
