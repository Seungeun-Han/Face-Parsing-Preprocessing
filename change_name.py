...
upper_path = os.path.join('D:/Dataset/CelebAMask-HQ-mask/labels_256')
"""# type_list = os.listdir(upper_path) # ['edges', 'images', 'cat_edges', 'labels']
type_list = ['edges', 'labels']
...
for type in type_list:
    ...
    for image in image_list:
        ...
        os.renames(os.path.join(image_path, image), os.path.join(image_path, image[:-4] + "_kf94" + image[-4:]))
    print("end")"""
