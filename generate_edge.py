...
im_path = os.path.join('D:\Dataset\ETRI_MaskDB\ETRI_MaskDB_473/images/')
...
save_dir = "D:/Dataset/CelebAMask-HQ/CelebA-HQ_th3px1_256/edges/"
...
for im_list in image_list:
    ...
    for idx, ann_list in enumerate(annotation_list):
        if parent_img_name in ann_list:
            ...
            parsing_anno = cv2.resize(parsing_anno, (256, 256))
