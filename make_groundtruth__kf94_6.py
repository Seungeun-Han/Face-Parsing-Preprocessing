...
image_list = [x for x in image_list if int(x[:5]) < 30000 and int(x[:5]) >= 20000]  # _ 조건 추가
...
save_dir = "D:/Dataset/CelebAMask-HQ-mask/CelebAMask-HQ-maskRendering_256/labels_necklace_Last/"
